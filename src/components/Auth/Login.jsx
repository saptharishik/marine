...
const OperationTracker = () => {
  ...
  const [boatPosition, setBoatPosition] = useState([12.9608484, 80.0580228]); // Chennai port initial position [lat, lng]
  ...
  const sourcePosition = [12.9608484, 80.0580228]; // Chennai port
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-900 text-white sm:w-[1700px] w-full">
      {/* Header */}
      ...
      <div className="flex flex-1 overflow-hidden w-full">
       ...
       <div className="w-64 bg-slate-800 shadow-xl overflow-y-auto">
        ...
        <div className="w-64 flex-1 relative w-full">
          {/* Map container */}
          <div 
            ref={mapContainerRef} 
